...
def get_commit_depth(baseline_tag):
    ...
    for s in raw_subjects.split('\n'):
        ...
        if "chore: promote candidate" in s: continue
...
def main():
    ...
    # --- SAFETY: SKIP MAIN ---
    # We do NOT want to calculate or force versions on main using THIS script.
    # Main relies on the manifest promotion logic in YAML.
